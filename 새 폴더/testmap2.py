...
class party:
    ...
    def party2(self):
        ...
        hp2 = 500+ self.hp2
        mp2 = 300+ self.mp2
        return ["킹기태",attack2, attack22, hp2, mp2]
    def party3(self):
        attack3 = 100+self.attack3
        attack33 = 150 + self.attack33
        hp3 = 500+ self.hp3
        mp3 = 300+ self.mp3
        return ["약범규",attack3, attack33, hp3, mp3]
    def party4(self):
        attack4 = 100+self.attack4
        attack44 = 150 + self.attack4
        hp4 = 500+ self.hp4
        mp4 = 300+ self.mp4
        return ["보우연재",attack4, attack44, hp4, mp4]
    def inven(self):
...
def battle(win,potion,elix, ramen, stat1,stat2,stat3,stat4):
    ...
    while True:
        ...
        print(f"{mon[0]}이 {players[m][0]}을 때렸습니다.")
        players[m][3] -= mon[1]
