...
#
#
# def bosses(Diablo, Wuyeon, Ilsungkim, MinJuSeok, KyuBeom, ChulMoom, Ado):
#     boss_list = [Diablo, Wuyeon, Ilsungkim, MinJuSeok, KyuBeom, ChulMoom, Ado]
#     return boss_list
...
class Mon_Status:
    def Diablo(self):
        self.name = '디아복로👹'
        self.attack = random.randrange(1, 2)
        self.hp = random.randrange(1, 2)
...
def battle(win,potion,elix,ramen, stat1,stat2,stat3,stat4):
    ...
    # Diablo = MON.Diablo()
    # Wuyeon = MON.Wuyeon()
    # Ilsungkim = MON.Ilsungkim()
    # MinJuSeok = MON.MinJuSeok()
    # KyuBeom = MON.KyuBeom()
    # ChulMoom = MON.ChulMoom()
    # Ado = MON.Ado()
    ...
    while True:
            ...
            pass
                ...
                if mon[2] <= 0:
                    ...
                    for i in range(1, 5):
                        ...
                        if boss_kill_list[0] == 1 and boss_kill_list[1] == 1 and boss_kill_list[2] == 1 and \
                                boss_kill_list[3] == 1 and boss_kill_list[4] == 1 and boss_kill_list[5] == 1 and \
                                boss_kill_list[6] == 1:
        ...
        # if boss_kill_list[0] == 1 and boss_kill_list[1] == 1 and boss_kill_list[2] == 1 and boss_kill_list[3] == 1 and boss_kill_list[4] == 1 and boss_kill_list[5] == 1 and boss_kill_list[6] == 1:
        #     print("의용군 파티가 다시 한번 세상을 구했습니다!\n 중간계에 평화가 찾아왔습니다.")
        #     exit()
